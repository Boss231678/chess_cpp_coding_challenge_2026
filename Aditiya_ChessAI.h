#ifndef ADITIYA_CHESS_AI_H
#define ADITIYA_CHESS_AI_H
...
class Aditiya_ChessAI : public ChessAIBase { // Fix: Inherit from base
public:
...
REGISTER_CHESS_AI(Aditiya_ChessAI, "Aditiya");
#endif
